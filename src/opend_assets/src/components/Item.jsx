...
function Item(props) {
  ...
  const [loadHidden, setLoaderHidden] = useState(true);
  ...
  // TODO: Remove when deploying to live
  agent.fetchRootKey();
  let NFTActor;
  ...
  async function sellItem() {
    ...
    const listItem = await opend.listItem(props.id, Number(price));
    console.log("Listing Result: " + listItem);
    if (listItem == "Sucess") {
